...
namespace UnityEngine.Tilemaps
{
	...
	public class RandomTile : Tile
	{
		...
		public int fixedSprite = 0;
		public bool useFixedSprite = false;
		...
		public override void GetTileData(Vector3Int location, ITilemap tileMap, ref TileData tileData)
		{
			...
			if ((m_Sprites != null) && (m_Sprites.Length > 0))
			{
				...
				else tileData.sprite = m_Sprites[fixedSprite];
			}
		}
	...
	public class RandomTileEditor : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			tile.useFixedSprite = EditorGUILayout.Toggle(tile.useFixedSprite);
			if(tile.useFixedSprite)
			tile.fixedSprite = EditorGUILayout.IntField("Fixed Sprite", tile.fixedSprite);
			if (count < 0)
				count = 0;
